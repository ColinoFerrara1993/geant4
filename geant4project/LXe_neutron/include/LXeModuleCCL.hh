...
//
#ifndef LXeModuleCCL_h
#define LXeModuleCCL_h 1
...
class LXeModuleCCL : public G4PVPlacement
{
 public:
 
  LXeModuleCCL(G4RotationMatrix* pRot, const G4ThreeVector& tlate,
  ...
  G4LogicalVolume* getlogicShape3() const {return flogicShape3;}
