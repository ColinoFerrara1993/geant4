...
#ifndef ElectricFieldMessenger_h
#define ElectricFieldMessenger_h 1
...
{
  public:
    ElectricFieldMessenger(ElectricFieldSetup* );
  ...
  private:
    ...
    G4UIcmdWithADoubleAndUnit* fEleFieldZCmd;
    G4UIcmdWith3VectorAndUnit* fEleFieldCmd;
    G4UIcmdWith3VectorAndUnit* fLocalEleFieldCmd;
