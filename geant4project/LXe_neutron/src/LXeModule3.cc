...
LXeModule3::LXeModule3(G4RotationMatrix* pRot, const G4ThreeVector& tlate,
  ...
  , fConstructor(c)
{
  ...
  G4double shape5_rmin =  2.5*mm, shape5_rmax = 3.*cm;
  ...
  // Shape 6 - Beam pipe 4
  //
  G4double shape6_rmin =  0.*mm, shape6_rmax = 2.5*mm;
  ...
  G4double shape9_rmin =  2.5*mm, shape9_rmax = 3.*cm;
  ...
  //
  G4double shape10_rmin =  0.*mm, shape10_rmax = 2.5*mm;
