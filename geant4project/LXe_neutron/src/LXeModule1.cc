...
LXeModule1::LXeModule1(G4RotationMatrix* pRot, const G4ThreeVector& tlate,
                             G4LogicalVolume* pMotherLogical, G4bool pMany,
                             G4int pCopyNo, LXeDetectorConstruction* c)
  // Pass info to the G4PVPlacement constructor
  : G4PVPlacement(pRot, tlate,
                  // Temp logical volume must be created here
                  new G4LogicalVolume(new G4Box("temp4", 40.*cm, 40.*cm, 1.79*m),
                                      G4Material::GetMaterial("Vacuum"), "temp4",
                                      0, 0, 0),
                  "housing4", pMotherLogical, pMany, pCopyNo)
  , fConstructor(c)
{
